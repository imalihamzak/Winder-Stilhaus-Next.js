    ...
    <span className="block w-5 h-[2px] bg-white rounded-full" />
      ...
      <section
        className="
          relative mx-auto
          text-white
          pt-28 sm:pt-32 md:pt-36 pb-7 sm:pb-10 md:pb-12
        "
  style={{
        ...
        <div className={`${containerClass} relative z-10`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-10 lg:gap-16 items-start">
            ...
            >
              ...
              <motion.h1
                className="text-white font-noto-serif"
                style={{
                  fontSize: "clamp(2rem, 4vw, 2.75rem)", /* Refined: 32px - 44px */
                  lineHeight: "1.25", /* Tighter for large headings */
              ...
              <motion.p
                className="text-white max-w-xl font-dm-sans lead"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                ...
                style={{ 
                  ...
                  lineHeight: '1.625', /* Relaxed for readability */
                  marginTop: '1rem',
                }}
              >
              ...
              >
                <a
                  ...
                  className="group inline-flex items-center justify-center gap-2 min-w-[122px] min-h-[31px] px-6 py-2 rounded-md bg-white border-2 border-[#214B57] text-[#214B57] text-sm font-normal font-dm-sans hover:bg-[#214B57] hover:text-white hover:border-[#F04E22] hover:shadow-[0_0_0_2px_rgba(240,78,34,0.2)] transition-all duration-150 focus:outline-none focus:ring-1 focus:ring-[#F04E22]/40 focus:ring-offset-1 active:bg-[#214B57] active:text-white active:border-[#F04E22] disabled:bg-[#4A4A4A] disabled:text-[#7F8C8D] disabled:cursor-not-allowed transform translateZ-0"
                >
