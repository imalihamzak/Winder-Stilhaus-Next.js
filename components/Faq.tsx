...
export default function FAQSection() {
  ...
  return (
    <section className="px-3 sm:px-4 md:px-6 relative overflow-hidden" style={{ background: 'linear-gradient(180deg, #214B57 0%, #183941 100%)' }}>
      {/* Ring pattern underlay: large scale, cropped off-edge, visible opacity, subtle parallax */}
      <div className="hidden md:block">
        <MonogramUnderlay opacity={0.2} />
      </div>
      <div className="max-w-7xl mx-auto pt-12 md:pt-16 lg:pt-20 pb-12 md:pb-16 lg:pb-20 relative z-10">
        {/* Heading */}
        ...
        <div className="max-w-4xl mx-auto mt-12 md:mt-16 lg:mt-20">
          <div className="rounded-[28px] border border-[#4A4A4A] bg-white shadow-[0_30px_90px_rgba(0,0,0,0.1)] overflow-hidden">
            ...
            <div className="divide-y divide-[#7F8C8D]/20">
              {faqs.map((faq, index) => {
                        ...
                        >
                          <div className="px-6 sm:px-8 pb-8">
                            <motion.div
                              ...
                              style={{ fontSize: 'clamp(0.875rem, 1.25vw, 1rem)', fontWeight: 400, lineHeight: '1.625', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif' }}
                            >
                              {faq.answer}
                            </motion.div>
          ...
          {/* CTA row */}
          <FadeIn className="mt-12 md:mt-16 flex flex-col sm:flex-row items-center justify-between gap-4">
