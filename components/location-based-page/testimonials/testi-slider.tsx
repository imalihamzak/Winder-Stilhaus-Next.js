...
export default function TestimonialsSlider({location}: TestimonialsSliderProps) {
  ...
  return (
    <section className="bg-[#1D1D1D] text-white px-3 sm:px-4 md:px-6 relative overflow-hidden select-none">
      <div className="max-w-7xl mx-auto relative py-12 md:py-16 lg:py-20">
        {/* Heading */}
        <FadeIn className="relative text-center mb-12 md:mb-16 lg:mb-20 px-2" duration={0.6}>
          ...
          <h2 className="mt-6 text-white font-noto-serif" style={{ fontSize: 'clamp(1.5rem, 3vw, 2rem)', fontWeight: 600, lineHeight: '1.5', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
            What Our Clients Say in {location}
      </h2>

          <p className="mt-6 text-white/90 max-w-2xl mx-auto font-dm-sans lead" style={{ fontSize: 'clamp(1.125rem, 1.5vw, 1.25rem)', fontWeight: 400, lineHeight: '1.625', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif' }}>
        ...
        {testimonials.map((_, i) => (
          ...
          />
              ...
              <div className="flex md:hidden justify-center gap-3">
                ...
                <button
                  onClick={next}
                  className="min-w-[122px] min-h-[31px] px-5 py-2 rounded-md bg-white border-2 border-[#214B57] text-[#214B57] text-sm font-normal font-dm-sans hover:bg-[#214B57] hover:text-white hover:border-[#F04E22] hover:shadow-[0_0_0_2px_rgba(240,78,34,0.2)] transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-[#F04E22] focus:ring-offset-2 active:bg-[#214B57] active:text-white active:border-[#F04E22] shadow-[0_2px_8px_rgba(0,0,0,0.15)] transform translateZ-0"
                >
                  Next →
                </button>
              </div>
