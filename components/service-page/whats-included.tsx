        ...
        <div className="grid md:grid-cols-2 gap-4">
          {service.includes?.map((item, i) => (
            ...
            >
                ...
                <p className="text-[#1D1D1D] font-dm-sans" style={{ fontSize: 'clamp(0.875rem, 1.25vw, 1rem)', fontWeight: 400, lineHeight: '1.625', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif' }}>{item}</p>
              </div>
            </FadeIn>
          ))}
        </div>
