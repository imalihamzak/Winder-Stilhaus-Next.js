          ...
          {steps.map((step, index) => {
            ...
            >
                ...
                {step.title}
                  ...
                  <p className="text-[#7F8C8D] font-dm-sans" style={{ fontSize: 'clamp(0.875rem, 1.25vw, 1rem)', fontWeight: 400, lineHeight: '1.625', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif', color: '#7F8C8D' }}>{step.desc}</p>
                </div>
              </FadeIn>
            );
          })}
