          ...
          {projects.map((item, i) => (
            ...
            >
              ...
              />
                ...
                <div className="p-5">
                  <h4 className="text-[#1D1D1D] font-noto-serif mb-1" style={{ fontSize: 'clamp(1.125rem, 1.5vw, 1.25rem)', fontWeight: 500, lineHeight: '1.5', letterSpacing: '0px', fontFamily: 'Noto Serif, serif', color: '#1D1D1D' }}>
                  {item.title}
                </h4>
                  <p className="text-[#7F8C8D] mb-3 font-dm-sans" style={{ fontSize: 'clamp(0.875rem, 1.25vw, 1rem)', fontWeight: 400, lineHeight: '1.625', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif', color: '#7F8C8D' }}>
                  {item.location}
                </p>
                <a
                    href="/project"
