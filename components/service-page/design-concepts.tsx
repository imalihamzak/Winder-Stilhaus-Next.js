                ...
                >
                  <div className="relative h-64 overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                      <h3 className="text-white font-semibold font-noto-serif mb-1" style={{ fontSize: 'clamp(1.25rem, 1.5vw, 1.5rem)', fontWeight: 500, lineHeight: '1.5', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
                        {concept.name}
                      </h3>
                      <p className="text-white/90 text-sm font-dm-sans line-clamp-2" style={{ fontSize: 'clamp(0.875rem, 1.25vw, 1rem)', fontWeight: 400, lineHeight: '1.625', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif' }}>
                        {concept.intent}
                      </p>
                    </div>
                  </div>
          ...
          >
            ...
            <div className="grid lg:grid-cols-2 gap-0">
              ...
              <div className="p-6 sm:p-8 lg:p-10">
                <h3 className="text-[#1D1D1D] font-noto-serif mb-4" style={{ fontSize: 'clamp(1.5rem, 3vw, 2rem)', fontWeight: 600, lineHeight: '1.5', letterSpacing: '0px', fontFamily: 'Noto Serif, serif', color: '#1D1D1D' }}>
                ...
                <div className="mb-6">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="font-semibold text-[#1D1D1D] font-noto-serif" style={{ fontSize: 'clamp(1.25rem, 1.5vw, 1.5rem)', fontWeight: 500, lineHeight: '1.5', letterSpacing: '0px', fontFamily: 'Noto Serif, serif', color: '#1D1D1D' }}>
                      Design Intent
                    </h4>
                  </div>
                  <p className="text-[#7F8C8D] font-dm-sans" style={{ fontSize: 'clamp(1rem, 1.25vw, 1.125rem)', fontWeight: 400, lineHeight: '1.625', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif', color: '#7F8C8D' }}>
                ...
                <div className="mb-8 p-5 rounded-xl bg-[#214B57]/5 border border-[#214B57]/20">
                  ...
                  <p className="text-[#7F8C8D] font-dm-sans" style={{ fontSize: 'clamp(0.875rem, 1.25vw, 1rem)', fontWeight: 400, lineHeight: '1.625', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif', color: '#7F8C8D' }}>
