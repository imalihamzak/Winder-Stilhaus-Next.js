            ...
            <div className="divide-y divide-black/10">
              ...
              >
                      <div className="min-w-0">
                        <p className="font-semibold text-[#1D1D1D] font-noto-serif" style={{ fontSize: 'clamp(1rem, 1.25vw, 1.125rem)', fontWeight: 500, lineHeight: '1.5', letterSpacing: '0px', fontFamily: 'Noto Serif, serif', color: '#1D1D1D' }}>
                {faq.question}
                        </p>
                      </div>
                      <span
                      ...
                      {isOpen && (
                        ...
                        >
                          <div className="px-5 sm:px-7 pb-6">
                            <div className="rounded-2xl border border-[#4A4A4A] bg-white p-5 text-[#7F8C8D] font-dm-sans shadow-[0_18px_45px_rgba(0,0,0,0.1)]" style={{ fontSize: 'clamp(0.875rem, 1.25vw, 1rem)', fontWeight: 400, lineHeight: '1.625', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif', color: '#7F8C8D' }}>
                  {faq.answer}
                </div>
                          </div>
                        </motion.div>
