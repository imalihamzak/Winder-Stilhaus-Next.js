...
export default function StepFiveComplexity({ data, setData, next, back }: PricingStepProps) {
  const inputClass =
    ...
    <div>
      <div className="mb-7">
        ...
        <p className="text-[#7F8C8D] mt-2 font-dm-sans" style={{ fontSize: 'clamp(1rem, 1.5vw, 1.75rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif' }}>
          What level of structural changes are required?
        </p>
      </div>

      <div className="space-y-4 mb-8">
        <div>
          <label htmlFor="complexity" className="block text-sm font-semibold text-[#1D1D1D] mb-3 font-dm-sans">
