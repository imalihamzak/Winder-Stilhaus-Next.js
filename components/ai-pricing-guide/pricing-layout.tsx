...
export default function InstantPricingGuide() {
  ...
  return (
    <section id="pricing-guide" className="relative text-white overflow-hidden" style={{ background: 'linear-gradient(180deg, #214B57 0%, #183941 100%)' }}>
      <div className="relative z-10 max-w-7xl mx-auto px-3 sm:px-4 md:px-6 pt-12 md:pt-16 lg:pt-20 pb-12 md:pb-16 lg:pb-20">
        {/* Heading */}
        <FadeIn className="text-center mb-12 md:mb-16 lg:mb-20 px-2">
          ...
          <h2 id="pricing-guide-heading" className="mt-6 text-white font-noto-serif max-w-2xl mx-auto" style={{ fontSize: 'clamp(1.5rem, 3vw, 2rem)', fontWeight: 600, lineHeight: '1.5', letterSpacing: '0px', fontFamily: 'Noto Serif, serif', color: '#FFFFFF' }}>
        ...
        <FadeIn className="max-w-6xl mx-auto">
          ...
          <div className="pt-8 md:pt-10 lg:pt-12">
            <p className="text-center text-xs sm:text-sm text-white/70 font-dm-sans">
