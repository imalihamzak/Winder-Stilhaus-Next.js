...
export default function Testimonials() {
  ...
  return (
    <section className="px-3 sm:px-4 md:px-6 relative overflow-hidden select-none bg-[#1D1D1D]">
      <div className="max-w-7xl mx-auto pt-12 md:pt-16 lg:pt-20 pb-12 md:pb-16 lg:pb-20 relative z-10">
        {/* Heading */}
        <FadeIn className="relative text-center mb-12 md:mb-16 lg:mb-20 px-2">
