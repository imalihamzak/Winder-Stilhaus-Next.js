    ...
    <>
      ...
      <section className="relative bg-[#1D1D1D] text-white pt-12 sm:pt-16 md:pt-20 pb-6 sm:pb-8 md:pb-10">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6">
          <FadeIn className="text-center" duration={0.6} delay={0.1}>
            ...
            <p className="text-white/90 max-w-2xl mx-auto mt-6 font-dm-sans lead" style={{ fontSize: 'clamp(1.125rem, 1.5vw, 1.25rem)', fontWeight: 400, lineHeight: '1.625', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif' }}>
      ...
      <section className="bg-[#1D1D1D]">
            ...
            return (
              <FadeIn key={i} direction="up" delay={i * 0.1} duration={0.6}>
                <div className="rounded-[24px] border border-[#4A4A4A] bg-white shadow-[0_18px_45px_rgba(0,0,0,0.1)] p-6 sm:p-8">
                  ...
                  <h3 className="font-semibold text-[#1D1D1D] mb-3 font-noto-serif" style={{ fontSize: 'clamp(1.25rem, 1.5vw, 1.5rem)', fontWeight: 500, lineHeight: '1.5', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
                    {service.title}
                  </h3>
                  <p className="text-[#7F8C8D] mb-4 font-dm-sans" style={{ fontSize: 'clamp(1rem, 1.25vw, 1.125rem)', fontWeight: 400, lineHeight: '1.625', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif' }}>
                    {service.description}
                  </p>
        ...
        <FadeIn className="mb-12" duration={0.6} delay={0.4}>
          <h2 className="font-semibold text-white mb-8 text-center font-noto-serif" style={{ fontSize: 'clamp(1.5rem, 2.5vw, 2rem)', fontWeight: 600, lineHeight: '1.5', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
            Aftercare Process
          </h2>
        ...
        <FadeIn duration={0.6} delay={0.5}>
          <div className="rounded-[30px] border border-white/20 text-white shadow-[0_30px_90px_rgba(0,0,0,0.2)] p-8 sm:p-10 text-center" style={{ background: 'linear-gradient(180deg, #214B57 0%, #183941 100%)' }}>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href="tel:+1234567890"
                className="inline-flex items-center gap-2 min-w-[122px] min-h-[31px] px-8 py-2 rounded-md border-2 border-white text-white font-normal font-dm-sans hover:bg-white hover:text-[#214B57] transition-all duration-150 transform translateZ-0"
              >
