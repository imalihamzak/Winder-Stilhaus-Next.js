        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {team.map((member, i) => (
            <FadeIn key={i} direction="up" delay={0.3 + (i * 0.15)} duration={0.6}>
              ...
              <div className="p-6">
                  <h4 className="font-semibold text-[#214B57] mb-1 font-noto-serif" style={{ fontSize: 'clamp(1.25rem, 1.5vw, 1.5rem)', fontWeight: 500, lineHeight: '1.5', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
                  {member.name}
                </h4>
