...
export default function AboutHero() {
  ...
  return (
    <section className="relative text-white pt-12 sm:pt-16 md:pt-20 pb-12 sm:pb-16 md:pb-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6">
        <FadeIn direction="up" delay={0.2} duration={0.6}>
          <div className="text-center">
            ...
            <p className="text-white/90 max-w-3xl mx-auto mt-6 font-dm-sans" style={{ fontSize: 'clamp(1rem, 1.5vw, 1.5rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif', color: 'rgba(255, 255, 255, 0.9)' }}>
        ...
        <FadeIn direction="up" delay={0.4} duration={0.6}>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-5xl mx-auto mt-8 md:mt-12 lg:mt-16">
            {stats.map((stat, i) => (
              <div
                key={i}
