      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-12 md:py-16 lg:py-20">
        ...
        <div>
            ...
            Founder & Creative Director
                ...
                <h3 className="font-semibold text-white mb-3 font-noto-serif" style={{ fontSize: 'clamp(1.5rem, 2.5vw, 2rem)', fontWeight: 500, lineHeight: '1.5', letterSpacing: '0px', fontFamily: 'Noto Serif, serif', color: '#FFFFFF' }}>
            Kiran Ahmed
          </h3>
                <p className="text-white/90 mb-6 font-dm-sans" style={{ fontSize: 'clamp(1rem, 1.25vw, 1.125rem)', fontWeight: 400, lineHeight: '1.625', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif', color: 'rgba(255, 255, 255, 0.9)' }}>
            ...
            leads every project with a passion for precision, innovation, and
                ...
                <p className="text-white/90 font-dm-sans" style={{ fontSize: 'clamp(1rem, 1.25vw, 1.125rem)', fontWeight: 400, lineHeight: '1.625', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif', color: 'rgba(255, 255, 255, 0.9)' }}>
              ...
              <div className="pt-4">
                <h4 className="font-semibold text-white mb-4 font-noto-serif" style={{ fontSize: 'clamp(1.125rem, 1.5vw, 1.25rem)', fontWeight: 500, lineHeight: '1.5', letterSpacing: '0px', fontFamily: 'Noto Serif, serif', color: '#FFFFFF' }}>Key Achievements</h4>
                <div className="grid sm:grid-cols-2 gap-3">
                  {achievements.map((achievement, i) => (
                    <div
                      key={i}
                      className="flex items-center gap-3 p-3 rounded-xl border border-[#4A4A4A] bg-white"
                    >
                      <div className="w-2 h-2 rounded-full bg-[#214B57]" />
                      <span className="text-sm text-[#1D1D1D] font-medium font-dm-sans">{achievement}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <a
                ...
                className="inline-flex items-center gap-2 min-w-[122px] min-h-[31px] px-6 py-2 rounded-md border border-[#4A4A4A] bg-white text-[#214B57] font-normal font-dm-sans shadow-[0_10px_25px_rgba(0,0,0,0.1)] hover:bg-[#4A4A4A]/5 transition"
              >
                <Linkedin size={18} />
                Connect on LinkedIn
              </a>
