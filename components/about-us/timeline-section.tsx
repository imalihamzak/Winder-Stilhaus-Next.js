              ...
              <FadeIn key={i} direction="up" delay={0.3 + (i * 0.1)} duration={0.6}>
                <div className="relative bg-white border border-[#4A4A4A] rounded-[28px] p-6 sm:p-8 hover:shadow-[0_25px_70px_rgba(0,0,0,0.1)] transition-all group overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    {/* Title */}
                    <h3 className="font-semibold text-[#1D1D1D] mb-3 font-noto-serif" style={{ fontSize: 'clamp(1.25rem, 1.5vw, 1.5rem)', fontWeight: 500, lineHeight: '1.5', letterSpacing: '0px', fontFamily: 'Noto Serif, serif', color: '#1D1D1D' }}>
                      {milestone.title}
                    </h3>

                    {/* Description */}
                    <p className="text-[#7F8C8D] leading-relaxed text-sm sm:text-base font-dm-sans" style={{ fontSize: 'clamp(0.875rem, 1.25vw, 1rem)', fontWeight: 400, lineHeight: '1.625', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif', color: '#7F8C8D' }}>
                      {milestone.desc}
                    </p>
