        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-12 md:mb-16">
          ...
          <FadeIn direction="left" delay={0.4} duration={0.6}>
            <div className="space-y-6">
              <div>
                <h3 className="font-semibold text-white mb-4 font-noto-serif" style={{ fontSize: 'clamp(1.5rem, 2.5vw, 2rem)', fontWeight: 500, lineHeight: '1.5', letterSpacing: '0px', fontFamily: 'Noto Serif, serif', color: '#FFFFFF' }}>
                  Our Journey
                </h3>
                <div className="space-y-4 text-white/90 font-dm-sans" style={{ fontSize: 'clamp(1rem, 1.25vw, 1.125rem)', fontWeight: 400, lineHeight: '1.625', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif', color: 'rgba(255, 255, 255, 0.9)' }}>
                  <p>
