...
export default function Services() {
  ...
  return (
    <section id="services" className="relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 pt-12 md:pt-16 lg:pt-20 pb-12 md:pb-16 lg:pb-20 relative z-10">
        {/* Heading */}
        <FadeIn className="text-center mb-12 md:mb-16 lg:mb-20">
          ...
          <h2 className="mt-6 text-white font-noto-serif max-w-2xl mx-auto" style={{ fontSize: 'clamp(1.5rem, 3vw, 2rem)', fontWeight: 600, lineHeight: '1.5', letterSpacing: '0px', fontFamily: 'Noto Serif, serif', color: '#FFFFFF' }}>
            Complete interior solutions
          </h2>

          <p className="mt-6 text-white/90 max-w-2xl mx-auto font-dm-sans lead" style={{ fontSize: 'clamp(1.125rem, 1.5vw, 1.25rem)', fontWeight: 400, lineHeight: '1.625', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif', color: 'rgba(255, 255, 255, 0.9)' }}>
        ...
        >
          ...
          >
            ...
            <button
              ...
              aria-label="Previous"
              className={`!absolute left-1 sm:left-2 md:left-3 top-1/2 -translate-y-1/2 z-30 w-9 h-9 sm:w-10 sm:h-10 md:w-11 md:h-11 rounded-full ws-double-ring bg-white shadow-[0_12px_30px_rgba(0,0,0,0.1)] flex items-center justify-center transition-all duration-150 border-2 border-[#214B57] text-[#214B57] hover:bg-[#214B57] hover:text-white hover:border-[#F04E22] hover:shadow-[0_0_0_2px_rgba(240,78,34,0.2)] focus:outline-none focus:ring-2 focus:ring-[#F04E22] focus:ring-offset-2 active:bg-[#214B57] active:text-white active:border-[#F04E22] transform translateZ-0 ${
                currentIndex > 0
                  ? "hover:bg-[#4A4A4A]/5 cursor-pointer opacity-100"
                  : "opacity-35 cursor-not-allowed pointer-events-none"
              }`}
            >
              <ChevronLeft className="text-current" size={16} />
            </button>
            ...
            <button
              ...
              aria-label="Next"
              className={`!absolute right-1 sm:right-2 md:right-3 top-1/2 -translate-y-1/2 z-30 w-9 h-9 sm:w-10 sm:h-10 md:w-11 md:h-11 rounded-full ws-double-ring bg-white shadow-[0_12px_30px_rgba(0,0,0,0.1)] flex items-center justify-center transition-all duration-150 border-2 border-[#214B57] text-[#214B57] hover:bg-[#214B57] hover:text-white hover:border-[#F04E22] hover:shadow-[0_0_0_2px_rgba(240,78,34,0.2)] focus:outline-none focus:ring-2 focus:ring-[#F04E22] focus:ring-offset-2 active:bg-[#214B57] active:text-white active:border-[#F04E22] transform translateZ-0 ${
                currentIndex < maxIndex
                  ? "hover:bg-[#4A4A4A]/5 cursor-pointer opacity-100"
                  : "opacity-35 cursor-not-allowed pointer-events-none"
              }`}
            >
              <ChevronRight className="text-current" size={16} />
            </button>
