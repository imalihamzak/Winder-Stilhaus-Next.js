...
export default function UnifiedCTA({
  ...
  return (
    <section className={`bg-[#1D1D1D] pt-12 md:pt-16 lg:pt-20 pb-12 md:pb-16 lg:pb-20 px-3 sm:px-4 md:px-6 ${className}`}>
            ...
            <div className="relative">
              ...
              <a
                ...
                className="
                  ...
                  min-w-[122px] min-h-[31px] px-5 py-2 rounded-md mt-6
