...
function BlogList() {
  ...
  return (
    <section className="bg-[#1D1D1D] text-white pb-0">
      <div className={containerClass + " pt-12 md:pt-16 lg:pt-20 pb-0"}>
        {/* Header */}
        <FadeIn direction="up" delay={0.1} duration={0.6} className="mb-12 md:mb-16 lg:mb-20">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-5">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#FFFFFF] border border-[#CED3D7] text-[11px] uppercase tracking-[0.32em] text-[#1D1D1D] font-dm-sans mb-6" style={{ fontSize: 'clamp(0.6875rem, 1vw, 0.875rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0.32em', fontFamily: 'DM Sans, sans-serif' }}>
        ...
        <FadeIn direction="up" delay={0.15} duration={0.6}>
          <div className="flex flex-wrap gap-2 sm:gap-3 mb-12 md:mb-16 pb-6 sm:pb-8 border-b border-[#7F8C8D]">
        ...
        {/* CTA Section */}
        <div className="mt-6 md:mt-8 pb-12 md:pb-16 lg:pb-20">
          <UnifiedCTA 
