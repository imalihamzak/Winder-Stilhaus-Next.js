    ...
    <>
      ...
      <section className="bg-[#1D1D1D] border-t border-[#4A4A4A]">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-12 md:py-16 lg:py-20">
          {/* Warranty Principles */}
          <FadeIn className="mb-12 md:mb-16 lg:mb-20" duration={0.6} delay={0.2}>
            <h2 className="font-semibold text-[#214B57] mb-12 text-center font-noto-serif" style={{ fontSize: 'clamp(1.5rem, 2.5vw, 2rem)', fontWeight: 600, lineHeight: '1.5', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
