...
export default function AreasWeCoverClient() {
  return (
    <section className="bg-[#1D1D1D] pt-12 sm:pt-16 md:pt-20 pb-16 sm:pb-20 md:pb-24 text-white">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6">
        ...
        <FadeIn direction="up" delay={0.1} duration={0.6} className="mb-10 md:mb-12">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-white font-noto-serif mt-6" style={{ fontSize: 'clamp(2rem, 4vw, 2.75rem)', fontWeight: 700, lineHeight: '1.25', letterSpacing: '-0.02em', fontFamily: 'Noto Serif, serif', color: '#FFFFFF' }}>
              Areas We Cover
            </h1>
            <p className="text-white/90 font-dm-sans lead mt-6" style={{ fontSize: 'clamp(1.125rem, 1.5vw, 1.25rem)', fontWeight: 400, lineHeight: '1.625', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif', color: 'rgba(255, 255, 255, 0.9)' }}>
            ...
            >
              <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                ...
                <div className={`${index % 2 === 1 ? "md:order-1" : ""}`}>
                  <h2 className="font-semibold text-white mb-4 font-noto-serif" style={{ fontSize: 'clamp(1.5rem, 3vw, 2rem)', fontWeight: 600, lineHeight: '1.5', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
                    {area.name}
                  </h2>
                  <p className="text-white/90 mb-6 font-dm-sans" style={{ fontSize: 'clamp(1rem, 1.25vw, 1.125rem)', fontWeight: 400, lineHeight: '1.625', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif' }}>
                    {area.description}
                  </p>
                  <Link
                    ...
                    className="
                      ...
                      bg-white border-2 border-[#214B57] text-[#214B57]
                      hover:bg-[#214B57] hover:text-white hover:border-[#F04E22]
                      hover:shadow-[0_0_0_2px_rgba(240,78,34,0.2)]
        ...
        <FadeIn direction="up" delay={0.8} duration={0.6}>
          <div className="mt-16 rounded-[30px] border border-white/20 shadow-[0_30px_90px_rgba(0,0,0,0.2)] p-8 sm:p-10 md:p-12 text-center" style={{ background: 'linear-gradient(180deg, #214B57 0%, #183941 100%)' }}>
            <div className="relative">
              <h2 className="text-white font-noto-serif mb-4" style={{ fontSize: 'clamp(1.5rem, 3vw, 2rem)', fontWeight: 600, lineHeight: '1.5', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
                Ready to Start Your Project?
              </h2>
              <p className="text-white/90 mb-8 max-w-2xl mx-auto font-dm-sans lead" style={{ fontSize: 'clamp(1.125rem, 1.5vw, 1.25rem)', fontWeight: 400, lineHeight: '1.625', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif' }}>
