...
export default function PostcodeGatePageClient() {
  ...
  return (
    <section className="bg-[#1D1D1D] min-h-screen pt-12 sm:pt-16 md:pt-20 pb-16 sm:pb-20 md:pb-24 text-white">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6">
        ...
        <FadeIn direction="up" delay={0.1} duration={0.6}>
          <div className="text-center mb-12 md:mb-16 lg:mb-20">
            ...
            <p className="text-white/90 max-w-3xl mx-auto font-dm-sans lead mt-6" style={{ fontSize: 'clamp(1.125rem, 1.5vw, 1.25rem)', fontWeight: 400, lineHeight: '1.625', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif', color: 'rgba(255, 255, 255, 0.9)' }}>
